...
O programa permite armazenar, consultar e atualizar dados sobre filmes e sessões, mantendo os registros salvos mesmo após o encerramento da execução.
...
Persistência de dados via arquivos .txt
Listagem de todas as sessões disponíveis
...
Manipulação de listas compostas em Python
Leitura e escrita em arquivos texto
Organização e persistência de dados sem uso de banco de dados
